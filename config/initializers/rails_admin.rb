...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['TDL Dark Archives']
 ...
 #config.navigation_static_label = "My Links"
  ...
  config.excluded_models = ['Bookmark', 'Search', 'MessageQueue']
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your bookmark.rb model definition
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your concept.rb model definition
